...
соответствующий количеству клеток (целое число). В классе должны быть реализованы методы
...
class Cell:
    ...
    def __sub__(self, other):
        return self.number - other.number if (self.number - other.number) > 0 else print('отрицательно')

    def __mul__(self, other):
        return Cell(int(self.number * other.number))

    def __truediv__(self, other):
        return Cell(round(self.number // other.quantity))
